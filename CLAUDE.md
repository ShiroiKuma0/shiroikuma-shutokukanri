...
| 白い熊 theme (default) | Black `#000000` background/surfaces + **pure yellow `#FFFF00`** text/icons/accents/borders (never material `#FFEB3B`); theme id `shiroikuma`, default for fresh installs + one-time seed for existing ones | `shared/app/.../ui/theme/DefaultThemes.kt`, defaults in `android/app/.../storage/AppSettingsStorage.kt`, seed in `android/app/.../util/AndroidUi.kt` |
| 白い熊 取得管理 UI page | Appearance settings page (sections with cascading indents: theme, 12 settable colors, external fonts with in-glyph previews, text-size scale); entry at top of Settings + long-press on the home hamburger | `android/app/.../pages/shiroikumaui/`, overrides storage `android/app/.../storage/ShiroikumaUiSettings.kt`, fonts `android/app/.../util/ShiroikumaFonts.kt`, color/font configurables under `android/app/.../ui/configurable/android/` |
